...
import vedicImage from "../assets/Astro-img.jpg"; // Add this if you have a local image for Vedic, or leave it as a placeholder below
...
const services = [
  ...
  },
  {
    ...
    image: vedicImage, // Replace or use placeholder if not available
    ...
    <section className="py-20 px-6 text-black-300">
      ...
      <div className="grid gap-10 max-w-6xl mx-auto grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
        {services.map(({ image, title, description }, i) => (
          <div
            key={title}
            className="bg-indigo-100 rounded-2xl p-8 shadow-md hover:shadow-yellow-400/60 transition-transform duration-300 transform hover:scale-105 cursor-default text-center"
